<?php
// Menu principal para las páginas secundarias
echo "<ul id='lista_principal_index'>
        <li class='inicio_logo'><a href='inicio' title='Inicio'><img src='./views/default/img/logo/png/logos versiones_Mesa de trabajo 1.png' alt='Inicio'/></a></li>
        <li class='elementos_menu'><a href='inicio' title='INICIO'>INICIO</a></li>
        <li class='elementos_menu'><a href='detras_de_fluidea' title='SOBRE MÍ'>SOBRE MÍ</a></li>
        <li class='elementos_menu'><a href='metodo_pop_up_flow' title='POP UP FLOW'>POP UP FLOW</a></li>
        ...
        <li id='menu_moviles'><i class='fa fa-bars' aria-hidden='true'></i></a>
            <ul id='lista_movil'>
		        ...
		        <li class='elementos_menu_moviles'><a href='detras_de_fluidea' title='SOBRE MÍ'>SOBRE MÍ</a></li>
        		<li class='elementos_menu_moviles'><a href='metodo_pop_up_flow' title='POP UP FLOW'>POP UP FLOW</a></li>
