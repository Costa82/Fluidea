...
<div class="contenedor_texto">
	...
	<div class="texto">
		...
		<ul class="lista_rosa">
			...
			<li><p>Aun no tienes ningún perfil de tu negocio en internet</p>
			</li>
			<li><p>Quieres tener un diseño de marca, porque sabes lo importante
					que es</p>
			</li>
			<li><p>No tienes ni idea de cómo usar un programa de diseño</p>
			</li>
			<li><p>No quieres ni puedes, gastarte miles de euros en un branding
					de marca</p>
			</li>
			<li><p>Si sabes que el diseño es importante pero no puedes contratar
					un diseñador al uso</p>
			</li>
			<li><p>Necesitas a parte de una marca, unos documentos físicos para
					poder repartir a tus clientes</p>
			</li>
		</ul>
...
<div class="contenedor_texto">
	...
	<div class="texto">
		...
		<p>¡Mira a ver cuál es el que más se adapta a tus necesidades! Y si
			aún no lo ves claro, siempre puedes preguntarme a mí.</p>
