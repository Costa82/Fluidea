...
<div class="contenedor_texto">
	...
	<div class="texto">
		...
		<p>En cumplimiento del Reglamento (UE) 2016/679 del Parlamento Europeo
			...
			RGPD), de la Ley 34/2002, de 11 de julio, de servicios de la sociedad
			de la información y de comercio electrónico (en adelante, LSSI-CE) y
			de la Ley Orgánica 3/2018, de Protección de Datos Personales y
			garantía de los derechos digitales FLUIDEA garantiza la protección y
		...
		<p>La Política de Protección de Datos de FLUIDEA descansa en el
		...
		<p>Los datos facilitados serán tratados en los términos establecidos
			en el RGPD, en este sentido FLUIDEA ha adoptado los niveles de
		...
		<p>
			Denominación: FLUIDEA (Beatriz Lozares)</br> CIF: 71152514J</br>
			Actividad: Consultor/Asesor</br> Dirección: Calle Duque de Lerma 1,
			Valladolid</br> Teléfono: 611412917</br> Correo electrónico:
			hola@fluidea.es
		</p>
		...
		<p>Todos los datos facilitados por nuestros clientes y/o visitantes en
			la web de FLUIDEA o a su personal, serán incluidos en registro de
			actividades de tratamiento de datos de carácter personal, creado y
			mantenido bajo la responsabilidad de FLUIDEA, imprescindibles para
			prestar los servicios solicitados por los usuarios, o para resolver
			las dudas o cuestiones planteadas por nuestros visitantes. Nuestra
			política es no elaborar perfiles sobre los usuarios de nuestros
			servicios.</p>

		<h3>Legitimidad del tratamiento: ¿Por qué necesitamos sus datos?</h3>

		<p>
			a) Relación contractual: Es la que aplica cuando compra uno de
			nuestros productos o contrata alguno de nuestros servicios. </br>b)
			Interés legítimo: Para atender a las consultas y reclamaciones que
			nos plantee y para gestionar el cobro de las cantidades adeudadas. </br>c)
			Su consentimiento: Si es usuario de nuestra web, mediante la
			...
			respuesta a la consulta o solicitud de información planteada.
		</p>
		...
		<p>No realizaremos transferencias internacionales de sus datos
			personales para ninguna de las finalidades indicadas.</p>

		<h3>Conservación: ¿Cuánto tiempo mantendremos tus datos?</h3>

		<p>Solo conservaremos sus datos personales durante el tiempo que
			resulte necesario para lograr los fines para los que fueron
			recabados. A la hora de determinar el oportuno periodo de
			conservación, examinamos los riesgos que conlleva el tratamiento, así
			como nuestras obligaciones contractuales, legales y normativas, las
			políticas internas de conservación de datos y nuestros intereses de
			negocio legítimos descritos en el presente Aviso de Privacidad y
			Política de Cookies.</p>

		<p>En este sentido, FLUIDEA conservará los datos personales una vez
			terminada su relación con Ud., debidamente bloqueados, durante el
			plazo de prescripción de las acciones que pudieran derivarse de la
			relación mantenida con el interesado.</p>

		<p>Una vez bloqueados, sus datos resultarán inaccesibles para FLUIDEA,
			y no serán tratados excepto para su puesta a disposición a las
		...
		<p>Empleamos todos los esfuerzos razonables para mantener la
			...
			permitan auditarles para verificar su cumplimiento.</p>
		...
		<p>
			a)
			<ins>Derecho de acceso</ins>
			a sus datos personales, para saber cuáles están siendo objeto de
			tratamiento y las operaciones de tratamiento llevadas a cabo con
			ellos; </br>b)
			<ins>Derecho de rectificación</ins>
			de cualquier dato personal inexacto; </br>c) <ins>Derecho de supresión</ins>
			de sus datos personales, cuando esto sea posible (por ejemplo, por
			imperativo legal); </br>d)
			<ins>Derecho de limitación</ins>
			del tratamiento de sus datos personales cuando la exactitud, la
			legalidad o la necesidad del tratamiento de los datos resulte dudosa,
			en cuyo caso, podremos conservarlos para el ejercicio o la defensa de
			reclamaciones. </br>e)
			<ins>Derecho de oposición</ins>
			al tratamiento de sus datos personales, cuando la base legal que nos
			habilite para su tratamiento de las indicadas sea nuestro interés
			legítimo. MERENDALIA CB dejará de tratar tus datos salvo que tenga un
			interés legítimo o sea necesario para la defensa de reclamaciones. </br>f)
			<ins>Derecho a la portabilidad</ins>
			de sus datos, cuando la base legal que nos habilite para su
			tratamiento sea la existencia de una relación contractual o su
			consentimiento. </br>g)
			<ins>Derecho a revocar el consentimiento</ins>
			otorgado a FLUIDEA
		</p>

		<p>Para ejercitar sus derechos, puede hacerlo de manera gratuita y en
			cualquier momento, contactando con nosotros en la dirección
			hola@fluidea.es, adjuntando copia de su DNI.</p>
		...
		<p>
			- Sede electrónica: https://www.aepd.es </br>- Correo postal: Agencia
			Española de Protección de Datos, C/ Jorge Juan, 6, 28001, Madrid </br>-
		...
		<h3>Actualizaciones: ¿Qué cambios puede haber en esta Política de
			Privacidad?</h3>

		<p>FLUIDEA se reserva el derecho a modificar la presente política para
			adaptarla a novedades legislativas o jurisprudenciales que puedan
			afectar el cumplimiento de la misma.</p>
